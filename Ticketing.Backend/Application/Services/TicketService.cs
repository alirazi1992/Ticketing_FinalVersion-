...
public interface ITicketService
{
    ...
    Task<TicketMessageDto?> AddMessageAsync(Guid ticketId, Guid authorId, string message);
}
...
public class TicketService : ITicketService
{
    ...
    public async Task<TicketMessageDto?> AddMessageAsync(Guid ticketId, Guid authorId, string message)
    {
