...
public static class SeedData
{
    public static async Task InitializeAsync(AppDbContext context, IPasswordHasher<User> passwordHasher)
    {
        ...
        var tech1 = new User { Id = Guid.NewGuid(), FullName = "Tech One", Email = "tech1@test.com", Role = UserRole.Technician, CreatedAt = DateTime.UtcNow };
        tech1.PasswordHash = passwordHasher.HashPassword(tech1, "Tech123!");
        var tech2 = new User { Id = Guid.NewGuid(), FullName = "Tech Two", Email = "tech2@test.com", Role = UserRole.Technician, CreatedAt = DateTime.UtcNow };
        tech2.PasswordHash = passwordHasher.HashPassword(tech2, "Tech123!");

        var client1 = new User { Id = Guid.NewGuid(), FullName = "Client One", Email = "client1@test.com", Role = UserRole.Client, CreatedAt = DateTime.UtcNow };
        client1.PasswordHash = passwordHasher.HashPassword(client1, "Client123!");
        var client2 = new User { Id = Guid.NewGuid(), FullName = "Client Two", Email = "client2@test.com", Role = UserRole.Client, CreatedAt = DateTime.UtcNow };
